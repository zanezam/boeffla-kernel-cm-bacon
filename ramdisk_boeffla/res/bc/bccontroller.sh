...
KERNEL_SPECS="bacon;cm;cm11.0s2;http://boeffla.df-kunde.de/bacon/boeffla-kernel-cms/"
...
if [ "lov_gov_profiles" == "$1" ]; then
	echo "zzmoove - optimal;zzmoove - battery;zzmoove - battery plus;zzmoove - battery yank;zzmoove - battery extreme yank;zzmoove - performance;zzmoove - insane;zzmoove - moderate;zzmoove - game"
	exit 0
fi
...
if [ "conf_cpu_volt" == "$1" ]; then
	...
	if [ "undervolt light" == "$2" ]; then
		echo "0;0;0;0;0;0;-25;-25;-25;-25;-25;-25;-25;-50;-50;-50;-50;-50"
	fi
	if [ "undervolt medium" == "$2" ]; then
		echo "-25;-25;-25;-25;-25;-25;-25;-50;-50;-50;-50;-50;-75;-75;-75;-75;-75;-75"
	fi
	if [ "undervolt heavy" == "$2" ]; then
		echo "-50;-50;-50;-50;-50;-50;-50;-75;-75;-75;-75;-75;-100;-100;-100;-100;-100;-100"
	fi
	exit 0
fi
...
if [ "apply_governor_profile" == "$1" ]; then
	...
	if [ "smartmax - standard" == "$2" ]; then
		echo "1026000" > /sys/devices/system/cpu/cpufreq/smartmax/awake_ideal_freq
		echo "1" > /sys/devices/system/cpu/cpufreq/smartmax/boost_duration
		echo "1512000" > /sys/devices/system/cpu/cpufreq/smartmax/boost_freq
		...
		echo "594000" > /sys/devices/system/cpu/cpufreq/smartmax/suspend_ideal_freq
		echo "1512000" > /sys/devices/system/cpu/cpufreq/smartmax/touch_poke_freq
